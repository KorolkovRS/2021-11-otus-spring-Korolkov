package ru.korolkovrs.spring23.impl;
...
import ru.korolkovrs.spring23.repository.BookRepository;
import ru.korolkovrs.spring23.service.impl.BookServiceImpl;
...
class BookServiceImplTest {
    ...
    void shouldSaveBook() {
        ...
        assertAll(
                ...
                () -> verify(repository, times(1)).save(book2)
        );
    }
