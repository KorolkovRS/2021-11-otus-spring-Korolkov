package ru.korolkovrs.spring20.changelogs;
...
public class initMongoDBDataChangeLog {
    ...
    public void addComments(MongockTemplate template) {
        comment1 = template.save(new Comment("Русская классика это страдание. Страдает главный герой, автор или читатель. " +
                        "Если страдают все трое, то это шедевр русской классики.", book2));
        comment2 = template.save(new Comment("Описание природы", book2));
        comment3 = template.save(new Comment("Золотая коллекция зарубежной фантазии", book3));
    }
}
